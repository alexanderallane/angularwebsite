<div class="jumbotron text-center" ng-controller="testCtrl as test">
        <h1>Test Page</h1>
        
        <p>{{ test.message }}</p>
    <div>
        <label for="checkbox">Start STEM Test</label>
...
<div ng-show="myVar">
    <section id="quiz-container">
        ...
        <div class="row">
  		  <div class="col-md-12">
			    ...
			    <div class="row">
				      <div class="col-md-12">
				        <h3>What is the subject that you enjoyed the most?</h3>

				        <div class="row answers-align">
		     				  <div class="col-sm-12">
	...
	<section id="result-container">
		<div id="result"></div>
		<div id="error" ng-hide="Oops! Please make sure you selected answer for all the questions!"></div>
    </section>
</div>
    </div>    
</div>
